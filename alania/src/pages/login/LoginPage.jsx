...
const LoginPage = () => {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      if (result.success) {
        ...
        navigate(`/check-code-for-login?email=${encodeURIComponent(email)}&redirect=${encodeURIComponent(from)}`);
      } else {
  ...
  return (
    ...
    >
      <h1 className="text-4xl font-extrabold text-gray-800 mb-8 drop-shadow-md">Connexion</h1>
      <p className="text-lg text-gray-600 mb-6">Veuillez entrer votre adresse email ci-dessous</p>
      <div className="w-full max-w-md flex flex-col items-center space-y-6">
        <div className="relative w-full">
          <input
            ...
            aria-describedby="email-error email-message"
          />
          <svg
